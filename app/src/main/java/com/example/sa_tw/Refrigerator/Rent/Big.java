...
public class Big extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout.setBackgroundResource(getResources().getIdentifier("@drawable/background_big", null, getPackageName()));

        /**確認按鈕**/
        Button confirm = new Button(this);
        confirm.setBackgroundResource(getResources().getIdentifier("@drawable/bigconfirm", null, getPackageName()));
        confirm.setX(180);
        confirm.setY(1580);
        ...
        cancel.setBackgroundResource(getResources().getIdentifier("@drawable/bigcancel", null, getPackageName()));
        cancel.setX(580);
        cancel.setY(1580);
        ...
        refrigerator.setImageResource(getResources().getIdentifier("@drawable/big", null, getPackageName()));
    ...
    View.OnClickListener  ok = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            new AlertDialog.Builder(Big.this)
