...
public class Middle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout.setBackgroundResource(getResources().getIdentifier("@drawable/background_middle", null, getPackageName()));

        /**確認按鈕**/
        Button confirm = new Button(this);
        confirm.setBackgroundResource(getResources().getIdentifier("@drawable/middleconfirm", null, getPackageName()));
        confirm.setX(180);
        confirm.setY(1580);
        ...
        cancel.setBackgroundResource(getResources().getIdentifier("@drawable/middlecancel", null, getPackageName()));
        cancel.setX(580);
        cancel.setY(1580);
        ...
        refrigerator.setImageResource(getResources().getIdentifier("@drawable/middle", null, getPackageName()));
    ...
    View.OnClickListener  ok = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            new AlertDialog.Builder(Middle.this)
